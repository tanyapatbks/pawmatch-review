...
function CreateReviewPage() {
  ...
  return (
    <div className='container mx-auto py-10'>
        <h3 className='text-3xl font-bold'>Create Review</h3>
        <hr className='my-3' />
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input onChange={(e) => setImg(e.target.value)} type="text" className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder='Post ImgUrl' />
            ...
            <button type='submit' className='bg-green-500 text-white border py-2 px-3 rounded text-lg my-2'>Create Review</button>
        </form>
